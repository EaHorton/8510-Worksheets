...
ggplot(g.g.rel, aes(x = state, y = count)) + geom_col(width = .7, fill="antiquewhite4") + labs(x="State", y="Number of Religious Institutions", title="Number of Religious Institutions")
```
